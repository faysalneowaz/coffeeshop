...
class _SelectOrganizationState extends State<SelectOrganization> {
  ...
  List listItemCity = ["Dhaka", "Rajshahi", "Khulna", "Bandarban", "Comilla","Barishal"];

    List listItemOrganization = ["Dhaka", "Rajshahi", "Khulna", "Bandarban", "Comilla","Barishal"];
        ...
        children: [
          InkWell(
            ...
            child: Container(
              ...
              child: Center(child: Text("Save",style: TextStyle(color: WHITE_COLOR),)),
            ),
          ),
          SizedBox(
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Center(child: Text("Cancel",style: TextStyle(color: WHITE_COLOR),)),
            ),
          ),
        ],
      ),
